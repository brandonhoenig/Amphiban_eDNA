...
Ref_Seqs_genbank <-
fetch_seqs("Amphibia", database = 'genbank', multithread = F, marker = '16S', output = 'gb-binom', db = "data/ncbi_taxdump")

Ref_Seqs_mt <-
fetch_seqs("Amphibia", database = 'nuccore', multithread = F, marker = 'mitochondria', output = 'gb-binom', db = "data/ncbi_taxdump")
```
